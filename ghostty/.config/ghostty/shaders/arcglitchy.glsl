...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // Transparency: adjust this value for more or less transparency (0.0 = fully transparent, 1.0 = fully opaque)
    float transparency = 0.5; // Adjust this as needed for transparency effect (0.0 to 1.0)
